...
export class MultiplayerUI {
  ...
  constructor(private api: GameAPI, private enter: () => Promise<void>, private leave: () => Promise<void>, private notify: (s:string)=>void, private openSnapshots?:()=>void) {
