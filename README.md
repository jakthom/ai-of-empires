...
Explore the offering Market and train a **Trade Cart** (100 wood, 50 gold). An idle, empty cart beside your own Market can accept one lot, carrying up to 500 of each resource on its respective leg. Payment reaches the seller at pickup; purchased goods reach you on return. Enable repeated trips to continue while the offer and funds remain available. Stop/move interrupts the cart; **Resume caravan** continues without charging twice. **Recall caravan** before pickup releases the seller’s goods and brings your payment home. Lost or converted carts lose undelivered cargo. Peaceful trading partners grant that caravan gate passage, without shared vision or general military access. Contracts, cargo, offers and merchant stock survive saves and restarts.

The **Merchants** page and a selected Market’s **Trade** tab exchange 100 food, wood, or stone against shared, finite stock. Initial quotes are 70 gold for a sale (84 for Saracens), or 130 gold for a purchase. Buying increases prices and selling decreases them; Go supplies the current quote. Merchant stock starts at 1,000 of each commodity and 2,000 gold, with no automatic replenishment. Player exchanges replenish it. Neutral-Market gold routes also draw from this finite treasury. Build another Market and you still face the same shared supply. Exchanges and caravan milestones appear in personal logs.

Built-in AI kingdoms advertise surplus resources against their own shortages and can fund carts to accept affordable, observed offers. They use the same commands and visibility rules as humans and MCP agents. Trade currently needs connected land: sea freight, automatic matching of separate offers, negotiated alliances and military access treaties remain future work. See [marketplace rules and API examples](docs/MARKETPLACE.md).
